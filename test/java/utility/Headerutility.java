...
public class Headerutility {
	...
	@FindBy(xpath="//*[@id=\"addEmpLbl\"]") WebElement addemp;
	...
	@FindBy(id="EmployeeLbl") WebElement emplabel1;
	@FindBy(id="searchEmpLbl") WebElement serchemp;
	...
	@FindBy(id="addDeptLbl") WebElement dept;
	public void adddept() {
	...
	@FindBy(id="DepartmentLbl") WebElement deptlab1;
	@FindBy(id="searchDeptLbl") WebElement serchdept;
	...
	@FindBy(id="EmployeeLbl") WebElement emplabel2;
	@FindBy(id="advSearchEmpLbl") WebElement adserch;
	public void advance() {
		assertTrue(emplabel.getText().equals("Employee"));
		emplabel.click();
	...
	@FindBy(id="EmployeeLbl") WebElement employe;
	@FindBy(id="showEmpsLbl") WebElement showall;
	public void employe() {
