...
public class AddDepartment {
	...
	public void adddept(String Department,String manager) {
		Commonsutility.checkEnabledAndDisplayed(deptlab,deptname,deptheadlab,submit);
	...
	public void afteradd(String deaprtmentid,String departmenthead,String departmrntname,String departmentdate) {
		Commonsutility.checkEnabledAndDisplayed(deptdetails,deptid,deptnamelab,depthead,createdate);
