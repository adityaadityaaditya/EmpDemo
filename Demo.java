...
public class Demo {
	...
	public static void main(String[] args) {
		System.setProperty("webdriver.chrome.driver","C:\\Users\\krish\\Desktop\\Drivers\\chromedriver_win32\\chromedriver.exe");
	  ...
	  List<WebElement> count = driver.findElements(By.xpath("//span[@class='a-size-medium a-color-base a-text-normal']"));
		...
		WebElement prdtTitle = driver.findElement(By.xpath("//a[contains(@href,'Redmi-comet-Blue-32GB-storage/dp/B07QT569GM')"));
		prdtTitle.click();
	   ...
	   WebElement addprdt = driver.findElement(By.xpath("//span[contains(text(),'Redmi 7 (Comet Blue, 3GB RAM, 32GB Storage)')]"));
		...
		if(name.equals(compareTitle)){
			...
			WebElement opp = driver.findElement(By.xpath("//span[contains(text(),'OPPO K3(Aurora Blue, 6GB RAM, 64GB Storage)')]"));
